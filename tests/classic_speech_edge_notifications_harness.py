...
class EdgeNotificationsPanelTests(unittest.TestCase):
    ...
    def test_panel_source_has_accessible_compact_edge_controls_without_legacy_status_captions(self):
        ...
        self.assertIn('title=_("Microsoft Edge notifications")', source)
        ...
        self.assertIn('renameMenuLabel=_("Set custom message\\tF2")', source)
        self.assertIn('clearRenameMenuLabel=_("Restore native message\\tDelete")', source)
        self.assertIn('renamePromptTitle=_("Custom notification message: {display}")', source)
        self.assertIn("Enter a custom notification message for '{display}'.", source)
        self.assertIn('checkedActionCaption=_("Announce")', source)
        self.assertIn('uncheckedActionCaption=_("Suppress")', source)
